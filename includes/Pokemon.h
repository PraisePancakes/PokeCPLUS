...
private:
    ...
    */
    ...
    Colors m_get_primary_type_color(std::string primary_type) const;
    Colors m_get_secondary_type_color(std::experimental::optional<std::string> secondary_type) const;
